...
## Current board snapshot (2025-11-14)
| ID | Title | Column | Owner/Role | Deliverable | Links |
|----|-------|--------|------------|-------------|-------|
| ST-B-001 | Investigate WLLS snapshot/materialize regression | Done - 2025-12-22 | Ingestion/Performance | 2025-12-22: Warm-run regression passed (WarmRunTelemetry-20251222-163820.json; improvement 64.94%; Cache=8/AccessRetry=2). <br> DeviceRepository now hydrates shared cache snapshots automatically (hoisted `StateTrace.Models.*` types + `Ensure-SharedSiteInterfaceCacheSnapshotImported`). <br> - 2025-12-22: Shared cache writes now merge host fragments in `DeviceRepository.Cache` so snapshots retain all hosts per site; cache-hit tests now expect `CacheStatus=Hit` on reuse (Pester: 246 passed). <br> - 2025-12-22: Warm-run telemetry now saves shared cache snapshots under `Logs/SharedCacheSnapshot` and refreshes `SharedCacheSnapshot-latest.clixml`; SkipSiteCacheUpdate guard now tracks `STATETRACE_SKIP_SITECACHE_UPDATE` alongside settings to prevent stale skip flags. <br> - 2025-12-22: Cache probe/refresh missing InterfaceSiteCacheMetrics traced to telemetry buffer flush timing; warm-run telemetry now flushes the buffer before cache probe/refresh to capture metrics. <br> - 2025-12-22: Warm regression rerun after snapshot pointer fix failed warm-run validation (206 hosts without SiteCacheProvider=Cache; 37 hosts without HostMapSignatureMatchCount; rewrote 1,440 cached host entries; Warm InterfaceCallDurationMs average 465.093 ms vs cold 234.309 ms). No WarmRunTelemetry emitted. Artifacts: Logs/IngestionMetrics/2025-12-22.json, Logs/IngestionMetrics/QueueDelaySummary-2025-12-22.json, Logs/Reports/PortBatchReady-2025-12-22.json, Logs/Reports/InterfaceSyncTiming-2025-12-22.json, Logs/Reports/PortBatchSiteDiversity-2025-12-22.json, Logs/Reports/ParserSchedulerLaunch-2025-12-22.json, Logs/Reports/SchedulerVsPortDiversity-2025-12-22.json, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251222-143405.clixml, Logs/SharedCacheSnapshot/SharedCacheSnapshot-latest.clixml, docs/performance/SchedulerVsPortDiversity-2025-12-22.md. <br> - 2025-12-22: Shared cache diagnostics after rerun: SnapshotImported=2279, GetHit=1342, GetMiss=1460; WLLS SharedCacheMatch=420/AccessCacheHit=120/SkipSiteCacheUpdate=150/AccessRefresh=5; BOYO AccessRefresh=176 (top host BOYO-A05-AS-02 avg fetch 394 ms) / SharedCacheMatch=16; SW1 SkipSiteCacheUpdate=30. Artifacts: Logs/IngestionMetrics/2025-12-22.json. <br> - 2025-12-21: Warm regression rerun with -SkipPortDiversityGuard completed cold+warm passes but failed warm-run validation (157 hosts without SiteCacheProvider=Cache; 37 hosts without HostMapSignatureMatchCount; rewrote 1,440 cached host entries). No WarmRunTelemetry-*.json emitted; queue delay summary missing (0 samples). Artifacts: Logs/IngestionMetrics/2025-12-21.json, Logs/Reports/PortBatchReady-2025-12-21.json, Logs/Reports/InterfaceSyncTiming-2025-12-21.json, Logs/Reports/ParserSchedulerLaunch-2025-12-21.json, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251221-070128.clixml.<br> - 2025-12-20: Warm regression rerun after telemetry fixes completed warm pass but failed warm-run validation (missing DatabaseWriteBreakdown/InterfaceSyncTiming; 37 hosts without SiteCacheProvider=Cache; 1 host missing HostMapSignatureMatchCount; rewrote 168 cached host entries). No `WarmRunTelemetry-*.json` emitted. Artifacts: `Logs/Reports/PortBatchReady-2025-12-20.json`, `Logs/Reports/InterfaceSyncTiming-2025-12-20.json`, `Logs/Reports/ParserSchedulerLaunch-2025-12-20.json`, `Logs/IngestionMetrics/QueueDelaySummary-2025-12-20.json`, `Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251220-230155.clixml`, `Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251220-230430.clixml`.<br> - 2025-12-20: Warm regression attempt failed the port batch diversity guard (WLLS streak 19 > limit 8); warm pass aborted. Artifacts: `Logs/Reports/PortBatchSiteDiversity-2025-12-20.json`, `Logs/Reports/PortBatchReady-2025-12-20.json`, `Logs/Reports/InterfaceSyncTiming-2025-12-20.json`.<br> - 2025-12-20: Warm regression rerun with `-SkipPortDiversityGuard` completed the cold pass but failed in `Invoke-WarmRunTelemetry.ps1` (`Collect-TelemetryForPass` missing `Count` property); warm pass aborted and no `WarmRunTelemetry-*.json` emitted. Artifacts: `Logs/Reports/PortBatchReady-2025-12-20.json`, `Logs/Reports/InterfaceSyncTiming-2025-12-20.json`, `Logs/Reports/ParserSchedulerLaunch-2025-12-20.json`.<br> - 2025-12-20: Expanded mock corpus (routing host list clones) + interface dispatch harness flushed queue metrics; queue delay summary now passes (SampleCount=8, QueueBuildDelay p95=12.43 ms / p99=16.65 ms). PortBatchReady report reflects 35 hosts; updated snapshot `Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251220-144919.clixml` and queue summary `Logs/IngestionMetrics/QueueDelaySummary-2025-12-20.json`.<br> - 2025-12-20: Site-cache materialization now skips template lookup when PortColor/ConfigStatus are already populated (and avoids config trim allocations). Diag pipeline on BOYO/WLLS mock logs shows SnapshotImported=4, GetMiss=96/GetHit=2; queue delay summary and PortBatchReady still missing (`Logs/IngestionMetrics/2025-12-20.json`, `Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251220-135800.clixml`). <br> - 2025-12-17: Parser hot path avoids a duplicate shared cache `GetHit`, and `TelemetryModule\Write-StTelemetryEvent` batches writes (flush-on `ParseDuration`/`SkippedDuplicate`) to reduce per-event mutex contention; mock BOYO/WLLS runs now ~7s wall time with `ParseDuration` ~2.4s/0.35s and `DatabaseWriteLatency` ~290ms/99ms (`Logs/IngestionMetrics/2025-12-17.json`). <br> - 2025-12-18: Cached per-DB Access index/seed ensures and switched shared-cache publishing to per-host fragments + shallow merges. New timings (`BulkSeedEnsureDurationMs`, `BulkSeedRecordsetOpenDurationMs`, `IndexEnsureDurationMs`) show seed ensure ~0.4 ms and recordset open ~21 ms; BOYO/WLLS mock run with shared cache disabled reports `DatabaseWriteLatencyMs` ~229 ms and `InterfaceCallDurationMs` ~208 ms (`Logs/IngestionMetrics/2025-12-17.json`). <br> - 2025-12-18: Cached regex compilation in parsing helpers (command blocks + table parsing), added a prompt fast-path, and gated explicit GC so small logs skip full collections; BOYO/WLLS mock run reports `ParseDuration` 2.48s/0.379s and `DatabaseWriteLatency` 275ms/101ms (`Logs/IngestionMetrics/2025-12-18.json`). <br> - 2025-11-28 09:56 MT: Pipeline + incremental checklist refreshed telemetry (`Logs/IngestionMetrics/2025-11-28.json`): SnapshotImported=3, InitNewStore=15, InitReuseStore=6, GetMiss=50/GetHit=24; WLLS AccessCacheHit=5/AccessRefresh=0; BOYO providers still `Unknown`; queue delay summary still skipped (0 samples); PortBatchReady remains synthetic/minimal (1 sw1 batch) despite dispatcher sweep (`Logs/DispatchHarness/RoutingQueueSweep-checklist-20251128-095600.json`). Next: rerun with richer host coverage to emit real PortBatchReady + BOYO provider counts, capture queue delay summary, then warm regression. <br> - 2025-11-13 09:20 MT: Added telemetry (`InterfaceSiteCacheClearInvocation`) + optional `-Reason` argument to `Clear-SiteInterfaceCache`, so every cache reset records the caller function/script and line number. <br> - 2025-11-13 08:55 MT: Reran `Tools\Invoke-StateTracePipeline.ps1 -SkipTests -VerboseParsing -SharedCacheSnapshotPath Logs/SharedCacheSnapshot-20251110-192915.clixml -RunSharedCacheDiagnostics`; analyzers now report `SnapshotImported=1`, `InitNewStore=29`, `GetHit=2,073`, and WLLS `AccessRefresh=216` vs. `AccessCacheHit=74` (BOYO 88/0). Need to trace why later runspaces clear the shared store before the warm regression. <br> - 2025-11-13 08:45 MT: Verified the module-level fix via `pwsh -NoLogo -Command "$env:STATETRACE_SHARED_CACHE_SNAPSHOT='Logs/SharedCacheSnapshot-20251110-192915.clixml'; Import-Module .\Modules\DeviceRepositoryModule.psm1 -Force; (DeviceRepositoryModule\Get-SharedSiteInterfaceCacheStore).Count"` (returns 7) and `Invoke-Pester Modules/Tests/DeviceRepositoryModule.Tests.ps1`. <br> - 2025-11-12 19:35 MT: Ran `Tools\Analyze-SharedCacheStoreState.ps1` + `Tools\Analyze-SiteCacheProviderReasons.ps1` (see `docs/CODEX_SHARED_CACHE_DIAGNOSTICS.md`). `SnapshotImported=0`, `InitNewStore=25`, `GetMiss=1,897` vs. `GetHit=1,842`; WLLS alone generated 1,148 misses and 192 `AccessRefresh` events (top hosts still 400-660 ms fetch). <br> - 2025-11-12 19:55 MT: Executed `Tools\Invoke-StateTracePipeline.ps1 -SkipTests -VerboseParsing -SharedCacheSnapshotPath Logs/SharedCacheSnapshot-20251110-192915.clixml -RunSharedCacheDiagnostics`. Snapshot restore reported 7 entries but diagnostics still show `SnapshotImported=0`, `InitNewStore=28`, `GetMiss=1,924` vs. `GetHit=2,066` and WLLS 216 `AccessRefresh` events (shared store still resets across parser workers). | docs/plans/PlanB_Performance.md |
| ST-B-002 | Trial reduced auto-scale ceilings post-batching | Done - 2025-12-22 | Ingestion | 2025-12-22: Ran `Tools\Invoke-StateTracePipeline.ps1 -SkipTests -VerboseParsing -ResetExtractedLogs -MaxWorkersPerSiteOverride 1 -MaxActiveSitesOverride 1` after resetting ingestion history. <br> - ParseDuration p95 1.176 s (avg 0.914 s, max 3.414 s); DatabaseWriteLatency p95 1009.8 ms (avg 743.6 ms, max 1255 ms) across 37 hosts. <br> - ConcurrencyProfileResolved: ResolvedMaxWorkersPerSite=1, ResolvedMaxActiveSites=1, ResolvedThreadCeiling=8, ResolvedJobsPerThread=4, ManualOverrides=True; pool MaxThreads=1. <br> - Recommendation: keep default ceilings; write latency p95 exceeds 950 ms cold gate. Artifacts: `Logs/IngestionMetrics/2025-12-22.json`, `Logs/Reports/ParserSchedulerLaunch-2025-12-22.json`, `Logs/Reports/PortBatchReady-2025-12-22.json`, `Logs/Reports/InterfaceSyncTiming-2025-12-22.json`. | docs/plans/PlanB_Performance.md |
| ST-B-003 | Codify concurrency overrides | Done - 2025-12-22 | Automation | 2025-12-22: Added `Tools/ConcurrencyOverrideGuard.psm1` to reset non-baseline concurrency settings in `Data/StateTraceSettings.json` after pipeline runs and emit `ConcurrencyOverrideSummary` telemetry when overrides are requested or reset; added `Modules/Tests/ConcurrencyOverrideGuard.Tests.ps1`. Updated `docs/CODEX_RUNBOOK.md` with override→metric mapping and reset/logging guidance. | docs/plans/PlanB_Performance.md |
| ST-B-005 | Validate keyed existing-row cache prototype | In Progress | Parser / Ingestion | 2025-12-23: Added cold-pass shared-cache disable + empty snapshot and reran warm telemetry (WarmRunTelemetry-20251223-151505.json) with cold avg 187.001 ms vs warm 103.864 ms (44.46% improvement), WarmCacheHitRatioPercentRaw=100 (SharedCache=37). Improvement below 60% gate; diff hotspot report emitted (all DiffComparisonDurationMs totals 0 ms). Shared cache diagnostics (2025-12-23.json): SnapshotImported=9, GetHit=809, GetMiss=300, Set=649; top sites WLLS=1137/BOYO=546/SW1=80. Provider reasons: BOYO AccessRefresh=15; WLLS AccessRefresh=10/AccessCacheHit=20/SkipSiteCacheUpdate=25; SW1 SkipSiteCacheUpdate=5; top AccessRefresh host WLLS-A01-AS-11 avg fetch 1155.94 ms. AccessRefresh drill-down shows ResolveInitialStatus=NotFound + high HostMapCandidateMissingCount for WLLS-A01-AS-11/BOYO-A05-AS-05 (15:01-15:15); warm pass later shows SharedCacheMatch at 15:15:34/35. Shared cache analyzers now accept `-StartTimeUtc`/`-EndTimeUtc` for run-scoped diagnostics (see `docs/CODEX_SHARED_CACHE_DIAGNOSTICS.md`). Cold window (2025-12-23T22:01:40Z-2025-12-23T22:15:15Z) shared store GetHit=284/GetMiss=32/Set=236 (SnapshotImported=0); provider reasons: BOYO AccessRefresh=4/SharedCacheMatch=58, WLLS AccessRefresh=4/SharedCacheMatch=122. Warm window (2025-12-23T22:15:30Z-2025-12-23T22:16:00Z) reports SharedCacheMatch only. 2025-12-23: Shared cache diagnostics run via `Tools/Invoke-WarmRunTelemetry.ps1 -GenerateSharedCacheDiagnostics -IncludeTests -SkipPortDiversityGuard`; cold window (2025-12-23T23:35:21Z-2025-12-23T23:36:37Z) SnapshotImported=0, GetHit=1/GetMiss=48/Set=5 (WLLS=39/SW1=16) with WLLS AccessCacheHit=4/SharedCacheMatch=1/SkipSiteCacheUpdate=5; warm window (2025-12-23T23:36:29Z-2025-12-23T23:38:07Z) SnapshotImported=0, GetHit=53/GetMiss=2/Set=43 (WLLS=62/BOYO=36) with SharedCacheMatch-only (BOYO=12, WLLS=25) and no AccessRefresh; cold pass missed InterfaceSiteCacheMetrics/DatabaseWriteBreakdown. 2025-12-23: Diagnosed missing cold-pass InterfaceSiteCacheMetrics/DatabaseWriteBreakdown as SkippedDuplicate-only (no ParseDuration); WarmRunTelemetry now forces ColdHistorySeed=Empty when GenerateSharedCacheDiagnostics is set (unless explicitly overridden) and warns on duplicate-only cold passes. 2025-12-23: Reran shared cache diagnostics with forced ColdHistorySeed=Empty (no OutputPath). WarmRunComparison: ColdHostCount=40, WarmHostCount=37, ColdInterfaceCallAvgMs=146.056, WarmInterfaceCallAvgMs=37.366, ImprovementPercent=74.42 (gate met). WarmCacheHitRatioPercentRaw=100 (SharedCache=37); cold providers SharedCache=34, Cache=2, Refreshed=2, Unknown=3. Cold window (2025-12-24T00:12:23Z-2025-12-24T00:14:14Z) SnapshotImported=0, GetHit=42, GetMiss=56, Set=46, Remove=1; top sites WLLS=97/BOYO=32/SW1=16; provider reasons include AccessRefresh=1 each for BOYO/WLLS; AccessRefresh hosts WLLS-A01-AS-11 avg 704.82 ms, BOYO-A05-AS-05 avg 220.26 ms. Warm window (2025-12-24T00:14:05Z-2025-12-24T00:14:33Z) SnapshotImported=0, GetHit=55, GetMiss=0, Set=6 with SharedCacheMatch-only (BOYO=12, WLLS=25). 2025-12-23: Reran shared cache diagnostics with OutputPath WarmRunTelemetry-20251223-172638.json. Diff hotspot report: `Logs/IngestionMetrics/WarmRunDiffHotspots-20251223-172638.csv` (TotalDiffComparisonMs=0.00 for BOYO/WLLS; Top 20 hosts all 0.00). WarmRunComparison: ColdHostCount=40, WarmHostCount=37, ColdInterfaceCallAvgMs=140.548, WarmInterfaceCallAvgMs=37.394, ImprovementPercent=73.39 (gate met), WarmCacheHitRatioPercentRaw=100 (SharedCache=37); cold providers SharedCache=34, Cache=2, ADODB=2, Unknown=3. Cold window (2025-12-24T00:26:40Z-2025-12-24T00:28:28Z) SnapshotImported=0, GetHit=42, GetMiss=56, Set=46, Remove=1; top sites WLLS=97/BOYO=32/SW1=16; AccessRefresh hosts WLLS-A01-AS-11 avg 787.38 ms, BOYO-A05-AS-05 avg 246.92 ms. Warm window (2025-12-24T00:28:18Z-2025-12-24T00:28:47Z) SnapshotImported=0, GetHit=55, GetMiss=0, Set=6 with SharedCacheMatch-only (BOYO=12, WLLS=25). <br> Artifacts: Logs/IngestionMetrics/2025-12-23.json, Logs/IngestionMetrics/QueueDelaySummary-2025-12-23.json, Logs/Reports/PortBatchReady-2025-12-23.json, Logs/Reports/InterfaceSyncTiming-2025-12-23.json, Logs/Reports/ParserSchedulerLaunch-2025-12-23.json, Logs/Reports/PortBatchSiteDiversity-2025-12-23.json, Logs/IngestionMetrics/WarmRunTelemetry-20251223-151505.json, Logs/IngestionMetrics/WarmRunDiffHotspots-20251223-151505.csv, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251223-151532.clixml, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251223-163747.clixml, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251223-171352.clixml, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251223-171416.clixml, Logs/IngestionMetrics/WarmRunTelemetry-20251223-172638.json, Logs/IngestionMetrics/WarmRunDiffHotspots-20251223-172638.csv, Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251223-172829.clixml. | docs/plans/PlanB_Performance.md |
| ST-A-001 | Verify InterfaceSync timing completeness | Done - 2025-11-14 | Ingestion/Routing | Telemetry completeness verified on 2025-11-14 (PortBatchReady=128, InterfaceSync=384, ParserSchedulerLaunch=86 / scheduler guard MaxObservedStreak=1) via Tools\Invoke-StateTracePipeline.ps1 -VerifyTelemetryCompleteness -FailOnTelemetryMissing and Tools\Test-IncrementalTelemetryCompleteness.ps1 -RequirePortBatchReady -RequireInterfaceSync -RequireSchedulerLaunch; analyzer outputs (Logs/Reports/PortBatchReady-2025-11-14.json, Logs/Reports/InterfaceSyncTiming-2025-11-14.json, Logs/Reports/ParserSchedulerLaunch-2025-11-14.json) and history CSVs (Logs/Reports/PortBatchHistory.csv, Logs/Reports/InterfaceSyncHistory.csv, Logs/Reports/QueueDelayHistory.csv, Logs/Reports/ParserSchedulerHistory.csv) back the queue p95/p99 = 20.02/20.76 ms evidence. | docs/plans/PlanA_RoutingReliability.md | Routed bundle README cites Logs/IngestionMetrics/2025-11-14.json + Logs/IngestionMetrics/QueueDelaySummary-20251114.json. |
...
| ST-D-003 | Incremental loading telemetry sweep | In Progress | UI + Ingestion | Latest bundle (`Logs/TelemetryBundles/Release-20251114/Telemetry/`) carries `PortBatchReady-20251114.json` (synthesized via `Tools/Add-PortBatchReadyTelemetry.ps1`), `PortBatchIntervals-20251114.json`, `Logs/Reports/PortBatchSiteDiversity-20251114.json`, `Logs/IngestionMetrics/QueueDelaySummary-20251114.json`, and the refreshed markdown set (`docs/performance/DispatcherGapCorrelation-20251114.md`, `docs/performance/PortBatchSiteGapSummary-20251114.md`, `docs/performance/WLLS_BOYO_GapTimeline-20251114.md`, `docs/performance/PortBatchSiteMix-20251114.md`, `docs/performance/DispatchHarnessSweepOrder-20251114-balanced2.md`, sweep JSON). Idle gaps dropped to 602 s (from 11,465 s) and queue delay p95/p99 sits at 20.02/20.76 ms, but `Tools/Test-PortBatchSiteDiversity.ps1` still fails (WLLS streak 25), so ST-D-010 continues driving the scheduler fix. Parser scheduler now enforces a `MaxConsecutiveSiteLaunches` cap (default 8, overridable via `-MaxConsecutiveSiteLaunchesOverride`), so the next incremental-loading run must confirm `ParserSchedulerLaunch-*.json` honors the guard before closing the task. | docs/plans/PlanD_FeatureExpansion.md |
| ST-D-010 | Investigate WLLS->BOYO idle gap | In Progress | UI + Scheduler | 2025-12-22 refresh: QueueDelaySummary 40 samples p95/p99 25.274/33.033 ms (QueueBuildDuration p95/p99 25.672/41.324; `Logs/IngestionMetrics/QueueDelaySummary-2025-12-22.json`), PortBatchReady 1101 events / 37 hosts / 72.471 ports/min (batch interval p95 2212 ms; `Logs/Reports/PortBatchReady-20251222-183813.json`), dispatcher gaps still show 20 idle gaps >=60s (max 12,500.2 s WLLS-A07-AS-07 -> BOYO-A05-AS-02; `docs/performance/DispatcherGapCorrelation-20251222-183813.md`). Root-cause check: InterfacePortStreamMetrics in the 18:36–18:38 UI window show 20 events (10 WLLS/10 BOYO) with max gap 2.789 s, and only 20/1101 PortBatchReady events are synthesized, so the multi-hour gaps are likely cross-run artifacts in the daily telemetry file. Gap analyzers now accept -StartTimeUtc/-EndTimeUtc for run-scoped evidence. Next: operator-facing incremental-loading session or run-scoped telemetry filtering. Validated the new time-window filters with a 07:42-07:44 local slice (20 events, max gap 3.24 s; outputs in `Logs/Reports/PortBatchIntervals-20251222-074200-local-filter.json`, `Logs/Reports/PortBatchGapTimeline-20251222-074200-local-filter.md`, `Logs/Reports/PortBatchSiteMix-20251222-074200-local-filter.md`). 2025-12-22 21:03 MT run-scoped telemetry (forced reparse by temporarily moving `Data/IngestionHistory`, restored afterward; run history saved to `Logs/Reports/IngestionHistory-run-20251222-210344`) captured `Logs/IngestionMetrics/Run-20251222-210344/2025-12-22.json` with PortBatchReady 24 events (ports/min 8102.531, p95 interval 414.583 ms, max gap 1.78 s, no gaps >=60) and InterfaceSyncTiming samples 36 (UiClone p95 37.275 ms, StreamDispatch p95 0.387 ms, Diff p95 61.186 ms). PortBatchReady hosts were WLLS-only (no BOYO), so WLLS->BOYO gaps remain unverified; QueueDelaySummary missing (0 samples). Artifacts: `Logs/Reports/PortBatchReady-20251222-210344.json`, `Logs/Reports/PortBatchIntervals-20251222-210344.json`, `docs/performance/PortBatchSiteGapSummary-20251222-210344.md`, `docs/performance/WLLS_BOYO_GapTimeline-20251222-210344.md` (1 s threshold), `docs/performance/PortBatchSiteMix-20251222-210344.md`, dispatcher sweep `Logs/DispatchHarness/RoutingQueueSweep-run-20251222-210344.json`, headless UI summary `Logs/Reports/InterfacesViewChecklist-20251222-210439.json` + `Logs/Reports/InterfacesViewQuickstart-20251222-210439.json`. 2025-12-23 run-scoped headless Interfaces run (`STATETRACE_TELEMETRY_DIR`) emitted only InterfacePortQueueMetrics; synthesized PortBatchReady (10 events, ports/min 7128.713, p95 interval 241.261 ms, max gap 0.25 s, no gaps >=1 s). Artifacts: `Logs/IngestionMetrics/Run-20251223-064548/2025-12-23.json`, `Logs/Reports/PortBatchReady-20251223-064548.json`, `Logs/Reports/PortBatchIntervals-20251223-064548.json`, `docs/performance/PortBatchSiteGapSummary-20251223-064548.md`, `docs/performance/WLLS_BOYO_GapTimeline-20251223-064548.md`, `docs/performance/PortBatchSiteMix-20251223-064548.md`, `Logs/Reports/InterfacesViewChecklist-20251223-064548.json`, `Logs/Reports/InterfacesViewQuickstart-20251223-064548.json`. 2025-12-23: Tools/Invoke-InterfacesViewChecklist.ps1 now flushes telemetry at the end of headless runs to ensure run-scoped outputs are written. 2025-12-23: Headless checklist now stages port stream data and emits InterfacePortDispatchMetrics per batch so stream/dispatch telemetry is available for PortBatchReady synthesis. 2025-12-23 validation: run-scoped headless checklist (Run-20251223-074813) recorded InterfacePortQueueMetrics=4, InterfacePortStreamMetrics=4, InterfacePortDispatchMetrics=6; outputs in Logs/IngestionMetrics/Run-20251223-074813/2025-12-23.json and Logs/Reports/InterfacesViewChecklist-20251223-074813.json. 2025-12-23: Headless checklist adds `-SynthesizePortBatchReady` to append PortBatchReady events after the run. 2025-12-23 validation: `-SynthesizePortBatchReady` run (Run-20251223-075348) appended 4 PortBatchReady events; outputs in `Logs/IngestionMetrics/Run-20251223-075348/2025-12-23.json`, `Logs/Reports/InterfacesViewChecklist-20251223-075348.json`, `Logs/Reports/InterfacesViewQuickstart-20251223-075348.json`. 2025-12-23: PortBatchReady synthesis now defaults on (disable with -SynthesizePortBatchReady:False). 2025-12-23: PortBatchReady summary for the default run reports 4 events, 12,447.207 ports/min, p95 interval 249.587 ms (Logs/Reports/PortBatchReady-20251223-085852.json). 2025-12-23: Updated Logs/Reports/PortBatchHistory.csv with the new summary. 2025-12-23 validation: default run (Run-20251223-085852) appended 4 PortBatchReady events; outputs in Logs/IngestionMetrics/Run-20251223-085852/2025-12-23.json, Logs/Reports/InterfacesViewChecklist-20251223-085852.json, Logs/Reports/InterfacesViewQuickstart-20251223-085852.json. 2025-12-23 pipeline run (-VerifyTelemetryCompleteness/-FailOnTelemetryMissing/-FailOnSchedulerFairness) failed PortBatchSiteDiversity guard because PortBatchReady was missing in `Logs/IngestionMetrics/2025-12-23.json` (queue delay summary 0 samples; InterfaceSyncTiming empty). 2025-12-23 run-scoped headless checklist (Run-20251223-103636) synthesized 10 PortBatchReady events; summary reports 10 events, 11,139.57 ports/min, p95 interval 243.171 ms (`Logs/Reports/PortBatchReady-20251223-103636.json`); history updated (`Logs/Reports/PortBatchHistory.csv`). 2025-12-23: Pipeline now supports `-RunQueueDelayHarness` (Full/Diag default) to emit InterfacePortQueueMetrics for queue delay summaries. 2025-12-23 pipeline run (-RunQueueDelayHarness) emitted InterfacePortQueueMetrics=4 and QueueDelaySummary p95/p99 18.852/18.970 ms (QueueBuildDuration p95/p99 22.920/23.026; `Logs/IngestionMetrics/QueueDelaySummary-2025-12-23.json`, dispatcher sweep `Logs/DispatchHarness/RoutingQueueSweep-pipeline-2025-12-23.json`). | docs/plans/PlanD_FeatureExpansion.md |
...
| ST-A-005 | Dispatcher alert integration | Done - 2025-12-22 | Ingestion/Telemetry | Dispatcher harness flushes telemetry buffer; queue delay summary `Logs/IngestionMetrics/QueueDelaySummary-2025-12-22.json` (20 samples, QueueBuildDelay p95 25.60 ms, p99 33.57 ms) sourced from `Logs/IngestionMetrics/2025-12-22.json`. Scheduler telemetry now flushes at parse completion and analyzer ignores synthesized events when real launches exist; pipeline run passes scheduler fairness (max streak 1) in `Logs/Reports/ParserSchedulerLaunch-2025-12-22.json` and `docs/performance/SchedulerVsPortDiversity-2025-12-22.md`. Port batch diversity guard uses synthesized events; `Logs/Reports/PortBatchSiteDiversity-2025-12-22.json` max streak 1. | docs/plans/PlanA_RoutingReliability.md |
| ST-A-006 | Routing evidence bundle linkage | Done - 2025-12-22 | Ingestion/PMO | Routing bundle published at `Logs/TelemetryBundles/Routing-20251222/Routing/` (queue summary + dispatcher harness sweep + session log + scheduler comparison). | docs/plans/PlanA_RoutingReliability.md |
| ST-A-007 | Roadmap M2: Routing discovery baseline | Backlog | PMO/Routing | Roadmap M2 (`docs/StateTrace_Quarterly_Roadmap.md`): discovery sessions + canonical `RouteRecord`/`RouteHealthSnapshot` schemas + routing data architecture notes; exit criteria: stakeholder-aligned route definitions, telemetry inventory gap analysis, reviewed diagrams. | docs/plans/PlanA_RoutingReliability.md |
...
| ST-B-009 | Toggle skip-site-cache policy safely | Done - 2025-12-22 | Ingestion | Guard module now flips `SkipSiteCacheUpdate` off/on for pipeline (`-DisableSkipSiteCacheUpdate`), warm-run telemetry, and shared-cache warmup; runbook updated. Warm harness now emits comparisons even when DB writes are sparse. Latest warm-run regression (`WarmRunTelemetry-20251222-170626.json`) shows warm avg 368.607 ms vs cold 1207.359 ms (+69.47%) with warm providers Cache=8 after filtering AccessRetry/AccessRefresh refresh events from warm provider counts (`WarmCacheHitRatioPercent=100`, SignatureMatchMissCount=0); snapshot `Logs/SharedCacheSnapshot/SharedCacheSnapshot-20251222-170829.clixml`. Shared cache diagnostics (`Logs/IngestionMetrics/2025-12-22.json`): SnapshotImported=2296, GetHit=2197, GetMiss=1684; BOYO AccessRefresh=177 (top host BOYO-A05-AS-02 avg fetch 394.24 ms), WLLS AccessRefresh=13/AccessCacheHit=136/SharedCacheMatch=808/SkipSiteCacheUpdate=170, SW1 SkipSiteCacheUpdate=34. Prior guarded run (`WarmRunTelemetry-20251201-guard-skipdiv7.json`, port diversity guard skipped) improved vs cold (+8.95%: warm avg 898.585 ms, cold 986.951 ms) with warm providers Cache=2,302 / Refresh=182 / Hydrate=20 / MissingDatabase=62 (`WarmCacheHitRatioPercent=89.71`, SignatureMatchMissCount=176); queue summary emitted; shared-cache analyzer shows `SnapshotImported=1` (still low) and `GetMiss=170`. Earlier guarded run (logs moved to `DebugLogs/`) had warm AccessCacheHit=14/AccessRefresh=0 with queue delay p95/p99=0.47/0.87 ms. Snapshot export path hardened (cache snapshot enumeration falls back to preserved snapshot store and ParserWorker retries empty exports with rehydration; Pester coverage added 2025-12-10); mock-corpus pipeline still emits empty snapshot despite diagnostics (`SnapshotImported=24`, `GetHit=118`, `GetMiss=560`)—need full corpus warm run to verify SITE1 host maps populate. Queue delay summary now carries SampleCount in the stats and history updater falls back to Count/root values to avoid missing-property warnings. | docs/plans/PlanB_Performance.md |
| ST-B-010 | Roadmap M1: Multi-DB ingestion foundation | Backlog | Ingestion/Performance | Roadmap M1 (`docs/StateTrace_Quarterly_Roadmap.md`): per-site queue + adaptive runspace pool, incremental persistence + parameterized commands, nightly `Maintain-AccessDatabases.ps1` compaction; exit criteria: no ACE/JET contention at 8 workers, throughput drop <=5% when doubling DBs, 14-day maintenance run success. | docs/plans/PlanB_Performance.md |
| ST-C-001 | Roadmap M3: Diff prototype & launch metrics instrumentation | Backlog | Parser/Analytics | Roadmap M3 (`docs/StateTrace_Quarterly_Roadmap.md`): diff data model prototype + metrics in `Logs/Research/DiffPrototype`, Phase 1 telemetry dictionary, launch metrics dashboard wireframes; exit criteria: diff prototype emits versioned snapshots, telemetry events stored locally, wireframes approved. | docs/plans/PlanC_ChangeTracking.md |
| ST-E-003 | Schedule daily rollup harness | Done - 2025-12-22 | Telemetry | Re-registered `StateTraceDailyRollup` to target `C:\Users\Werem\Projects\StateTrace\Tools\Invoke-DailyRollupScheduled.ps1` (2025-12-22); on-demand task run reported `Last Result: 1` because no same-day metrics were available, so a manual `Invoke-DailyRollupScheduled.ps1 -Days 30` pass produced `Logs/IngestionMetrics/IngestionMetricsSummary-20251222-060953.csv` (warnings for malformed lines in `2025-12-12.json`). Reran `Tools\Invoke-StateTracePipeline.ps1 -SkipTests -VerboseParsing -ResetExtractedLogs -SkipPortDiversityGuard` to create same-day metrics, then `schtasks /Run /TN StateTraceDailyRollup` succeeded (Last Result: 0) and wrote `Logs/IngestionMetrics/IngestionMetricsSummary-20251222-071331.csv` (queue delay summary had 0 samples; `InterfaceSyncTiming` summary empty). | docs/plans/PlanE_Telemetry.md, docs/runbooks/Schedule_Daily_Rollup.md |
| ST-E-007 | Release-readiness telemetry bundle | Done - 2025-12-23 | Telemetry/PMO | 2025-12-23: Published `Logs/TelemetryBundles/Release-2025-12-23/Telemetry` (README SHA256 `E35558FDF7E72E3DBD966A17B362258C994357D82312B1A71AF425F794080E9B`) with shared-cache analyzers, warm-run summary, diff hotspot CSV (no WarmPass diff entries), and doc-sync `2025-12-23_session-0013.md`. <br> Readiness output: `Logs/TelemetryBundles/Release-2025-12-23/VerificationSummary.json`. | docs/plans/PlanE_Telemetry.md |
...
| ST-E-009 | Plan A telemetry bundle handoff | Done - 2025-12-23 | Telemetry/Routing | 2025-12-23: Published `Logs/TelemetryBundles/Release-2025-12-23/Routing` (README SHA256 `471C2D5AB91599EC1385F718029CD93D965684C5AF933B1E798889306C265982`) with `QueueDelaySummary-2025-12-23.json`, `InterfaceSyncTiming-2025-12-23.json`, routing sweep JSON, and BOYO/WLLS dispatcher logs. <br> Readiness output: `Logs/TelemetryBundles/Release-2025-12-23/VerificationSummary.json`. | docs/plans/PlanE_Telemetry.md |
| ST-F-003 | NetOps session log enforcement | Done - 2025-11-13 | Automation/Security | Added `Tools\Test-NetOpsEvidence.ps1` + `Tools\Invoke-AllChecks.ps1 -RequireNetOpsEvidence` so NetOps/reset logs (with reasons) and session references are captured whenever `STATETRACE_AGENT_ALLOW_*` is used; lint now skips directory resolution when offline. | docs/plans/PlanF_SecurityIdentity.md |
| ST-F-009 | Online-mode reset automation | Done - 2025-11-13 | Automation/Security | `Tools\Reset-OnlineModeFlags.ps1 -Reason "<plan/task>"` clears `STATETRACE_AGENT_ALLOW_*`, records the reason, and writes `Logs/NetOps/Resets/OnlineModeReset-<timestamp>.json`; cite the log path + reason in Plan F updates, Task Board notes, and session logs whenever online mode is used. | docs/plans/PlanF_SecurityIdentity.md |
| ST-G-001 | Update release checklist with shared cache snapshot policy | Done - 2025-12-22 | Release | Added shared cache snapshot verification steps to `docs/Release.md` referencing `SharedCacheSnapshot-latest-summary.json` and `Tools\Test-SharedCacheSnapshot.ps1`. | docs/plans/PlanG_ReleaseGovernance.md |
| ST-G-002 | Link roadmap milestones to task board IDs | Done - 2025-12-22 | PMO | Added Task Board IDs to the Q4 roadmap and created matching milestone cards (ST-A-007/ST-B-010/ST-C-001) in the Task Board/CSV. | docs/plans/PlanG_ReleaseGovernance.md |
| ST-G-006 | Doc-sync enforcement hook | Done - 2025-12-22 | Docs/Governance | Added `Tools/Test-DocSyncChecklist.ps1` to validate plan/task board/backlog/session log updates and emit JSON summaries; `Tools/Invoke-AllChecks.ps1` now supports `-RequireDocSyncChecklist` with auto-output. Runbook/playbook/checklist updated. | docs/plans/PlanG_ReleaseGovernance.md |
| ST-G-007 | Telemetry bundle integration | In Progress | Release/Telemetry | Update `docs/Release.md` checklist + scheduled verification harness to require a `Tools/New-TelemetryBundle.ps1` artifact link, run `Tools\Test-TelemetryBundleReadiness.ps1 -IncludeReadmeHash -SummaryPath` per `docs/runbooks/Telemetry_Bundle_Verification.md`, and log the bundle README hashes + summary path before approvals.  2025-12-23: Release-2025-12-23 readiness recorded (Telemetry README SHA256 `E35558FDF7E72E3DBD966A17B362258C994357D82312B1A71AF425F794080E9B`, Routing README SHA256 `471C2D5AB91599EC1385F718029CD93D965684C5AF933B1E798889306C265982`, summary `Logs/TelemetryBundles/Release-2025-12-23/VerificationSummary.json`). <br> 2025-12-23: Invoke-StateTraceScheduledVerification.ps1 now accepts -TelemetryBundlePath/-VerifyTelemetryBundleReadiness; schedule runbook notes -AdditionalArguments for bundle checks. | docs/plans/PlanG_ReleaseGovernance.md |
...
| ST-G-009 | Schedule verification runs | Done - 2025-12-22 | Release/Ops | `Tools/Invoke-StateTraceScheduledVerification.ps1` now writes `Logs/Verification/VerificationSummary-<timestamp>.json` plus `VerificationSummary-latest.json` with warm-run/shared-cache/queue evaluations and transcript path. | docs/plans/PlanG_ReleaseGovernance.md |
| ST-G-010 | Schedule verification task | Done - 2025-12-22 | Release/Ops | Added `Tools/Schedule-VerificationTask.ps1` plus `docs/runbooks/Schedule_Verification.md`; registered `StateTraceVerification` at 03:00 with `-IncludeTests` (next run 2025-12-23 03:00). | docs/plans/PlanG_ReleaseGovernance.md |
| ST-H-001 | Launch user onboarding + freshness visibility | In Progress | UI/Docs | Quickstart anchor added to Operators runbook, UI smoke checklist updated, headless harness emits a summary (`-SummaryPath`), toolbar Help opens the quickstart anchor, and a toolbar freshness label surfaces the last ingest/age per site. Headless onboarding screenshots are staged at `docs/performance/screenshots/onboarding-20251126-154036-*.png`; next: add cache-source telemetry and refresh captures from the WPF shell. Latest evidence bundled at `Logs/TelemetryBundles/UI-20251126-useraction9/` (includes `PlanHReadiness.json`). | docs/plans/PlanH_UserExperience.md |
| ST-H-004 | Fix search/alerts port sorting | Done - 2025-12-19 | UI | Search + Alerts views sort ports by PortSort keys; async refresh now proceeds when interface data is already loaded even if `InterfacesLoadAllowed` is false, and the Insights worker merges queued view requests so search/alerts refresh is not dropped when later updates arrive. | docs/plans/PlanH_UserExperience.md |
| ST-H-005 | Headless Search/Alerts smoke harness | Done - 2025-12-19 | UI | Added `Tools/Invoke-SearchAlertsSmokeTest.ps1` to load Search/Alerts in a hidden WPF host and assert grid binding; UI smoke checklist + Codex runbook now call out the headless check and require it for new UI features/functions, and `Tools/Invoke-AllChecks.ps1` runs it by default. | docs/plans/PlanH_UserExperience.md |
| ST-K-005 | Code review findings remediation (batch 1) | Done - 2025-12-21 | Automation | Address high-severity items from `docs/notes/2025-12-21_code_review_findings.md` and keep status updates logged there; findings 1-3, 4-6, 7-14, 15-33, 34-54, 55-63, 65-69, 70-76, 72, 77, 81-86, 88-98, and 99-100 complete; 64 verified locked (schema warnings, DeviceDetails/Insights diagnostics, parser/filter/repo cleanup warnings, cache event caps, module import warnings, tooling JSON helper, streamed telemetry parsing, cache sync, bounded polling/timeouts, export dialog suppression with view/headless opt-in). | docs/plans/PlanK_DeveloperExperience.md |
| ST-E-010 | Harden telemetry buffer concurrency | Done - 2025-12-19 | Telemetry | Telemetry buffer and shared cache event arrays now use runspace-safe locks to prevent concurrent list mutation; Pester pass. | docs/plans/PlanE_Telemetry.md |
...
- **Investigate WLLS snapshot/materialize regression** - [Ingestion][Performance] Deliverable: identify why WLLS-A01-AS-01 cold hydrations jumped from ~0.65 s to ~2.7 s after 2025-10-24 autoscale trials, focusing on snapshot/materialize stages and associated caching.
  ...
  - 2025-12-01 13:45 MT status: Added `Tools/SkipSiteCacheUpdateGuard.psm1` and hooked it into `Tools/Invoke-StateTracePipeline.ps1` (`-DisableSkipSiteCacheUpdate`), `Tools/Invoke-WarmRunTelemetry.ps1`, and `Tools/Invoke-SharedCacheWarmup.ps1` so runs can flip `SkipSiteCacheUpdate` off and auto-restore the setting. Updated `docs/CODEX_RUNBOOK.md` and Plan B; next runs should capture cold + warm telemetry with the guard enabled and record the paths in the plan/task updates.
