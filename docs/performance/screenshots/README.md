# Screenshot Storage (Onboarding / UI evidence)

Store onboarding and UI evidence here using the naming pattern:
- `onboarding-<yyyyMMdd-HHmmss>.png` for toolbar/Interfaces/help shots (Plan H ST-H-001).
