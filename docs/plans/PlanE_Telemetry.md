...
<!-- LANDMARK: ST-E-001 gates link normalization (PlanE status) -->
<!-- LANDMARK: ST-E-004 phase1 dictionary coverage -->
- Phase 1 telemetry dictionary (`docs/telemetry/Phase1_metrics.md`) now documents InterfaceSiteCacheMetrics, InterfaceSyncTiming, InterfacePortQueueMetrics, PortBatchReady, ParserSchedulerLaunch, WarmRunComparison, and core UserAction coverage; plan gate references are linked back to the dictionary (ST-E-004 complete).
...
<!-- LANDMARK: ST-E-004 plan completion -->
| ST-E-004 | Phase 1 dictionary coverage refresh | Telemetry + Plan owners | Done - 2026-01-02 | Added schema rows for InterfaceSiteCacheMetrics, InterfaceSyncTiming, InterfacePortQueueMetrics, PortBatchReady, ParserSchedulerLaunch, WarmRunComparison, and core UserAction coverage; linked plan gates back to the dictionary. Evidence: docs/telemetry/Phase1_metrics.md; docs/telemetry/Automation_Gates.md; Logs/Verification/AllChecks-ST-E-004-20260103-213359.log; Logs/Reports/DocSyncChecklist-ST-E-004-20260103-213413.json; docs/agents/sessions/2026-01-02_session-0030.md. |
| ST-E-005 | Telemetry gate enforcement harness | Automation | Done - 2026-01-04 | Created `Modules/Tests/TelemetryGateEnforcement.Tests.ps1` (22 tests) with reusable gate validation functions: `Test-ParseDurationGate`, `Test-DatabaseWriteLatencyGate`, `Test-QueueDelayGate`, `Test-UserActionCoverageGate`, `Test-AllTelemetryGates`. Documents all thresholds from `docs/telemetry/Automation_Gates.md` (ParseDuration P95≤3s/Max≤10s, DatabaseWriteLatency P95≤950ms cold/500ms warm, QueueDelay P95≤120ms/P99≤200ms with ≥10 samples). Queue delay enforcement already integrated in `Tools/Invoke-StateTraceVerification.ps1`. |
...
| ST-E-007 | Release-readiness telemetry bundle | PMO + Telemetry | Done - 2025-12-23 | 2025-12-23: Published `Logs/TelemetryBundles/Release-2025-12-23/Telemetry` (README SHA256 `E35558FDF7E72E3DBD966A17B362258C994357D82312B1A71AF425F794080E9B`) with shared-cache analyzers, warm-run summary, diff hotspot CSV (no WarmPass diff entries), and doc-sync `2025-12-23_session-0013.md`; readiness summary `Logs/TelemetryBundles/Release-2025-12-23/VerificationSummary.json`. <br> 2025-12-26: Release-2025-12-26 Telemetry README SHA256 `2DF39256742B4D4B5952CE5AA81B8D7FA0C7AD0BCDF3EB53851AD9CFE2E8D737`; readiness summary `Logs/TelemetryBundles/Release-2025-12-26/VerificationSummary-20251226-133656.json`. |
| ST-E-008 | Task board alignment | Telemetry | Done - 2025-12-26 | Updated TaskBoard + CSV telemetry entries with the Release-2025-12-26 bundle evidence and readiness summary (see ST-E-007 note). |
...
| ST-E-011 | TelemetryModule unapproved verbs cleanup | Telemetry | Done - 2025-12-24 | 2025-12-24: Renamed Flush-StTelemetryBuffer -> Save-StTelemetryBuffer (approved verb) with legacy alias; updated tool call sites/tests; AllChecks (SkipSpanHarness) log: `Logs/Verification/AllChecks-ST-E-011-SkipSpan-20251224-134304.log`. |
...
|----|------|---------|----------|
<!-- LANDMARK: ST-E-001 automation gates linkage -->
| ST-E-001 | 2026-01-02 | Linked plan docs to shared telemetry thresholds in docs/telemetry/Automation_Gates.md. | docs/telemetry/Automation_Gates.md, Logs/Verification/AutomationGatesLinkResolution-20260102-201344.log, Logs/Verification/AllChecks-ST-E-001-20260102-191700.log, Logs/Reports/DocSyncChecklist-ST-E-001-20260102-215930.json, docs/agents/sessions/2026-01-02_session-0022.md. |
...
|-----------|---------|---------------------|--------|
<!-- LANDMARK: PlanE ST-B-008 telemetry bundle readiness evidence -->
<!-- LANDMARK: ST-E-004 timeline update -->
| 2026-01-02 | Completed Phase 1 dictionary coverage refresh (added schema rows for InterfaceSiteCacheMetrics, InterfaceSyncTiming, InterfacePortQueueMetrics, PortBatchReady, ParserSchedulerLaunch, WarmRunComparison, core UserAction; plan gate links refreshed). | docs/telemetry/Phase1_metrics.md; docs/telemetry/Automation_Gates.md; Logs/Verification/AllChecks-ST-E-004-20260103-213359.log; Logs/Reports/DocSyncChecklist-ST-E-004-20260103-213413.json. | docs/agents/sessions/2026-01-02_session-0030.md |
| 2026-01-01 | Published a Plan B telemetry bundle to keep Plan E/G release evidence current. | `Logs/TelemetryBundles/Release-20260101-ST-B-008-20260101-145226`; `Logs/Verification/PublishTelemetryBundle-ST-B-008-20260101-145226.log`; `Logs/TelemetryBundles/Release-20260101-ST-B-008-20260101-145226/VerificationSummary-ST-B-008-20260101-145236.json`; `Logs/Verification/TelemetryBundleReadiness-ST-B-008-20260101-145236.log`. | Tools/Publish-TelemetryBundle.ps1 |
...
<!-- LANDMARK: ST-E-001 gates link normalization (PlanE gates) -->
## Telemetry gates
- See [docs/telemetry/Automation_Gates.md](../telemetry/Automation_Gates.md) for per-plan tables; Plan E maintains that file.
